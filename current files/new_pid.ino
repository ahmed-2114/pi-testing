...
//
// Pi bridge note:
//   This sketch keeps the new_pid controller and adds the same UART JSON bridge
//   used by esp_correct_pid_pi.ino for pi_master.py / pi_mecanum_path_builder.py.
//
...
void setup() {
  ...
  sendJsonLine("{\"type\":\"ready\",\"baud\":115200,\"source\":\"new_pid\",\"imu\":" + String(imuOk ? "true" : "false") + ",\"imuCalValid\":" + String(imuCalValid ? "true" : "false") + "}");
}
